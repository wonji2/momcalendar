...
// 🧠 문장형 발화 — AI 해석(ANTHROPIC_API_KEY) 이 켜진 뒤에만 정답이 card 다. `BOT_AI=1 node …` 로 켠다.
//   키 없이 돌리면 전부 text 라 가짜 경보가 되므로 기본 실행에선 뺀다 (2026-09-06).
if (process.env.BOT_AI) CASES.push(
